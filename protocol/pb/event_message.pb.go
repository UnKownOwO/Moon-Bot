...
type MessageSender struct {
	...
	// 当私聊类型为群临时会话时的额外字段
	GroupId int64 `protobuf:"varint,5,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"` // 临时群消息来源群号
	// 如果是群聊
	Card  string `protobuf:"bytes,6,opt,name=card,proto3" json:"card,omitempty"`    // 群名片／备注
	Area  string `protobuf:"bytes,7,opt,name=area,proto3" json:"area,omitempty"`    // 地区
	Level string `protobuf:"bytes,8,opt,name=level,proto3" json:"level,omitempty"`  // 成员等级
	Role  string `protobuf:"bytes,9,opt,name=role,proto3" json:"role,omitempty"`    // 角色, owner 或 admin 或 member
	Title string `protobuf:"bytes,10,opt,name=title,proto3" json:"title,omitempty"` // 专属头衔
}
...
type MessageEvent struct {
	...
	// 私聊消息
	TargetId   int64 `protobuf:"varint,12,opt,name=target_id,json=targetId,proto3" json:"target_id,omitempty"`       // 收到私聊消息的机器人 QQ 号
	TempSource int32 `protobuf:"varint,13,opt,name=temp_source,json=tempSource,proto3" json:"temp_source,omitempty"` // 临时会话来源
	// 群聊消息
	GroupId    int64             `protobuf:"varint,14,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`          // 群号
	Anonymous  *MessageAnonymous `protobuf:"bytes,15,opt,name=anonymous,proto3" json:"anonymous,omitempty"`                      // 匿名信息, 如果不是匿名消息则为 null
	MessageSeq int64             `protobuf:"varint,16,opt,name=message_seq,json=messageSeq,proto3" json:"message_seq,omitempty"` // 消息序列
}
...
func (x *MessageEvent) GetMessageSeq() int64 {
	if x != nil {
		return x.MessageSeq
	}
	return 0
...
var file_event_event_message_proto_rawDesc = []byte{
	...
	0xeb, 0x01, 0x0a, 0x0d, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x53, 0x65, 0x6e, 0x64, 0x65,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x66, 0x6c, 0x61, 0x67, 0x22, 0xf6, 0x03, 0x0a, 0x0c, 0x4d, 0x65,
	...
	,
}
